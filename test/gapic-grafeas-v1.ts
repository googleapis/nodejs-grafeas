...
describe('v1.GrafeasClient', () => {
    ...
    describe('listOccurrences', () => {
        it('invokes listOccurrences without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listOccurrences = (actualRequest: {}, options: {}, callback: Callback) => {
    ...
    describe('listOccurrencesStream', () => {
        it('invokes listOccurrencesStream without error', done => {
            ...
            const stream = client.listOccurrencesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
    ...
    describe('listNotes', () => {
        it('invokes listNotes without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listNotes = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listNotesStream', () => {
        it('invokes listNotesStream without error', done => {
            ...
            const stream = client.listNotesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listNoteOccurrences', () => {
        it('invokes listNoteOccurrences without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listNoteOccurrences = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listNoteOccurrencesStream', () => {
        it('invokes listNoteOccurrencesStream without error', done => {
            ...
            const stream = client.listNoteOccurrencesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
